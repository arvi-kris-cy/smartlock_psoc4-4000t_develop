...
*
* Description: This file contains all the function prototypes of Watchdog timer
*
...
uint32_t get_calibrated_wdt_match_value(uint32_t);
void set_wdt_match_value(uint32_t);
